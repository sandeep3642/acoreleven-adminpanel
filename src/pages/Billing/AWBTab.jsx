  ...
  return (
    <div className="bg-gray-50">
      <div className="bg-white rounded-lg shadow-sm">
        <div className="p-6">
          <h3 className="text-lg font-medium text-gray-700 mb-6">Shipper</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-2">Org Loc</label>
              <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-2">Postal</label>
              <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
          </div>
        </div>
         <div className="p-6">
          <h3 className="text-lg font-medium text-gray-700 mb-6">Consignee</h3>
         ...
         <div className="p-6">
          <h3 className="text-lg font-medium text-gray-700 mb-6">Shipment Information </h3>
         ...
         <div className="p-6">
          <h3 className="text-lg font-medium text-gray-700 mb-6">Other Information</h3>
